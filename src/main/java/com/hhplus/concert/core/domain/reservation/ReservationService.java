...
public class ReservationService {
    ...
    private final ReservationRedisRock reservationRedisRock;

    public ReserveConcertResult reserveConcertForRedis(String token, long scheduleId, long seatId) {
        String lockKey = "lock:결제:" + token;
        TransactionTemplate transactionTemplate = new TransactionTemplate(transactionManager);
        return reservationRedisRock.executeWithLock(
                lockKey,
                10,  // waitTime
                15,  // leaseTime
